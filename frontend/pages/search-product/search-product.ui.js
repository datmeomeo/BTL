...
const SearchProductUI = {
    ...
    renderBooks(books) {
        ...
        container.innerHTML = books
            .map((book) => {
                // 1. Sử dụng formatCurrency từ utils
                const price = formatCurrency(book.sellingPrice);

                // 2. Xử lý ảnh: Lấy trực tiếp, nếu null thì dùng ảnh mặc định
                const imgSrc = book.mainImage || "./assets/img/fahasa-logo.jpg";
    ...
    // GIỮ NGUYÊN PHẦN RENDER CATEGORY TREE
